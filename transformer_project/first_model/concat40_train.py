...
#from concat40_model import create_dataloader
#from concat40_model import ModifiedTransformerModel
from torch.utils.tensorboard import SummaryWriter
from add_model import create_dataloader
from add_model import ModifiedTransformerModel
#from new_PMT_encoding_vis import plot_encoded_data
...
def train_model(
    ...
    checkpoint_dir: str = "checkpoints_test_add",
    use_wandb: bool = True,
    project_name: str = "pmt_transformer",
    use_tensorboard: bool = True,  # Add a parameter to toggle TensorBoard logging
):
    """
    ...
    if use_tensorboard:
        writer = SummaryWriter(log_dir="runs/pmt_transformer_training")  # Log directory for TensorBoard
    ...
    for epoch in range(num_epochs):
        ...
        with tqdm(train_loader, desc=f'Epoch {epoch+1}/{num_epochs}') as pbar:
            for batch in pbar:
                ...
                # Get ground truth Q and Δt values (first value in each PMT's features)
